...
export const metadata: Metadata = {
  title: "Resources — field notes on AI that actually ships",
  description:
    "Practical writing on AI front desks, after-hours enquiries and patient booking automation for private clinics.",
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {RESOURCES.cards.map((card) => (
            ...
            >
              ...
              />
              <h2 className="mt-6 text-lg font-medium leading-snug text-foreground">
                {card.title}
              </h2>
